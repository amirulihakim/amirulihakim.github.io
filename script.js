...
const timahProjectTranslations = {
  en: {
    ...
    'project.backgroundDesc': 'During my internship at PT Timah Industri’s Maintenance Department, process measurements were monitored across several utility points through locally installed field instruments and existing panel-level interfaces.',
    'project.problem': 'Problem', 'project.problemDesc': 'Because readings were distributed across separate locations, centralized observation and convenient historical review were limited for day-to-day monitoring.',
    'project.built': 'What I Built', 'project.builtDesc': 'I developed a centralized data-acquisition and monitoring system that collected measurement data, stored timestamped records, and presented realtime and historical information through a browser-based dashboard.',
    'project.result': 'Result', 'project.resultDesc': 'The project improved measurement visibility by bringing distributed readings into one interface for acquisition, storage, realtime monitoring, and historical review.',
    ...
    'demo.label': 'Project dashboard', 'demo.heading': 'Interactive Dashboard',
    'demo.description': 'Explore real-time flow trends and historical records in the project dashboard.',
    'demo.cta': 'Open Dashboard', 'nav.allProjects': 'All projects',
  ...
  id: {
    ...
    'project.backgroundDesc': 'Selama magang di Departemen Maintenance PT Timah Industri, pengukuran proses dipantau pada beberapa titik utilitas melalui instrumen lapangan yang terpasang secara lokal dan antarmuka panel yang tersedia.',
    'project.problem': 'Permasalahan', 'project.problemDesc': 'Karena pembacaan tersebar di lokasi-lokasi terpisah, pengamatan terpusat dan peninjauan historis yang praktis masih terbatas untuk kebutuhan pemantauan sehari-hari.',
    'project.built': 'Yang Saya Bangun', 'project.builtDesc': 'Saya mengembangkan sistem akuisisi data dan monitoring terpusat yang mengumpulkan data pengukuran, menyimpan rekaman bertanda waktu, serta menyajikan informasi realtime dan historis melalui dashboard berbasis peramban.',
    'project.result': 'Hasil', 'project.resultDesc': 'Proyek ini meningkatkan visibilitas pengukuran dengan menyatukan pembacaan yang tersebar ke dalam satu antarmuka untuk akuisisi, penyimpanan, pemantauan realtime, dan peninjauan historis.',
    ...
    'demo.label': 'Dashboard proyek', 'demo.heading': 'Dashboard Interaktif',
    'demo.description': 'Jelajahi tren aliran real-time dan riwayat data melalui dashboard proyek.',
    'demo.cta': 'Buka Dashboard', 'nav.allProjects': 'Semua proyek',
...
function initializeImageLightbox() {
  ...
  if (!lightbox || !lightboxImage || !stage || !document.body.matches('.wtp-page, .energy-page, .defa-page, .mechanical-page, .facility-page, .robot-page')) return;

  const defaViewer = document.body.matches('.defa-page, .mechanical-page, .facility-page, .robot-page');
  ...
  document.querySelectorAll('.wtp-page main img, .energy-page main img, .defa-page main img, .mechanical-page main img, .facility-page main img, .robot-page main img').forEach(image => {
    image.tabIndex = 0;
    image.setAttribute('role', 'button');
    image.setAttribute('aria-label', `${document.body.matches('.energy-page, .defa-page, .mechanical-page, .facility-page, .robot-page') && document.documentElement.lang === 'id' ? 'Perbesar gambar' : 'Enlarge image'}: ${image.alt}`);
